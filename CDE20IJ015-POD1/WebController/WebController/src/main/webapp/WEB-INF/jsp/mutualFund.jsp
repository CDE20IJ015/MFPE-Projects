...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="mutualFund">Show Mutual Fund</a></li>
    </ul>
    ...
    <div class="container">
			...
			<div class="col-sm-6 ">
				<div class="card text-center shadow-lg">
					<img class="card-img-top img-fluid"
						src="https://content.indiainfoline.com/_media/iifl/img/article/2018-01/24/full/1516785778-9196.jpg"
		...
		<c:forEach items="${mutual}" var="mut">
			<tr>
				<td>${mut.mutualFundId}</td>
				<td>${mut.mutualFundName}</td>
				<td>${mut.mutualFundValue}</td>
