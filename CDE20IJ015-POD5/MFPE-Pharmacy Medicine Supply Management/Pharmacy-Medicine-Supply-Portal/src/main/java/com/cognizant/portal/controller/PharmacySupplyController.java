...
/**
 * This is the controller class for medicine supply page.
...
public class PharmacySupplyController {
	...
	/**
	 * This method will map with the url /getMedicineSupply 
	 * and provide the medicine demand if token is valid
	 */
