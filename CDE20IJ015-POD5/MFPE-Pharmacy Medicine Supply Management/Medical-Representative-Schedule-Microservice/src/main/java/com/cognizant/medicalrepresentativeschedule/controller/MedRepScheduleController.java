...
/**
 * This is the controller class for representative scheduling.
 */
@Slf4j
@RestController
public class MedRepScheduleController {
	...
	/**
	 * This method maps the url with the {scheduleStartDate} and checks the token  
	 *if the token is correct then it provides list of representatives
	 * if token is found incorrect it throws exception .
	 * 
	 * 
	 * 
