...
/**
 * This is the implementation class for MedRepScheduleService interface .
 */
@Slf4j
@Service
public class MedRepScheduleServiceImpl implements MedRepScheduleService {
	...
	/**
	 * This method provides the representative schedule if the token is found to be valid.
	 */
	@Override
