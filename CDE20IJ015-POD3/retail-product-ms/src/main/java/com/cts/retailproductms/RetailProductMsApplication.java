package com.cts.retailproductms;
...
@EnableFeignClients
@EnableSwagger2
public class RetailProductMsApplication {

	public static void main(String[] args) {
		SpringApplication.run(RetailProductMsApplication.class, args);
	}
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Product - API")
				.description("Product API reference for frontend Developpers")
