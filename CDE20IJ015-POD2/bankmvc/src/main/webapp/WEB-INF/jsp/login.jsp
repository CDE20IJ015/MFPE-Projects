...
body {
	...
	background-image:url("images/emplogins.v1.jpg");
	}
</style>
...
<body>
	...
	<div class="container">
		<div class="card login-card" style="background: rgb(0, 0, 0); /* Fallback color */ background: rgba(0, 0, 0, 0);">
			<div class="row">
				<div class="col-md-12">
					<div class="card-body">
						<div class="brand-wrapper" align="center">
							<h1 class="header " style="color: aliceblue;">JAKS Bank</h1>
						...
						<form:form action="/login" method="post" modelAttribute="login">
							...
							<form:input type="hidden" path="role" name="role" id="role"
								value="${role}" />
								<br>
							<input name="login" id="login" class="btn btn-dark"
