...
public class UserDetailsTest {
	...
	void testGetUserName() {
		userDetails.setUserName("Shuvam");
		assertEquals("Shuvam", userDetails.getUserName());
	}
	...
	void testGetPassword() {
		userDetails.setPassword("Shuvam");
		assertEquals("Shuvam", userDetails.getPassword());
	}
	...
	void testConstructor() {
		UserDetails ud = new UserDetails(1, "Shuvam", "Shuvam", "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMSIsImV4cCI6MTYxNTIyNTc5NywiaWF0IjoxNjE1MjIzOTk3fQ.IRD8qCvu6neU1Atkic1qcNnJd_YZEnzFa1F3oaBusiU", true);
		...
		assertEquals("Shuvam",ud.getUserName());
		assertEquals("Shuvam",ud.getPassword());
