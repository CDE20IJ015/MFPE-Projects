    ...
    <div class="container register">
      <div class="row">
        <div class="col-md-3 register-left">
          <img src="https://www.pinclipart.com/picdir/big/334-3341467_how-long-is-the-replacement-process-product-replacement.png" alt="" />
          <h3>Return Order Portal</h3>
          <p style="color:#addae0;">You are few steps away from returning your product.</p>
        </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      *</span> <input type="text" class="form-control"
                        placeholder="Credit Card" type="tel" pattern="[0-9]+" length="12" class="form-control" name="creditCardNumber"
                        id="creditCardNumber" placeholder="Enter 16 digit Credit Card Number" value="" required="required" maxlength="16" minlength="16" />
                    </div>
                    <div class="form-group">
